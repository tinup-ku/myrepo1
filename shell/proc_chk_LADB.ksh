...
####################################################################################################
##                                                                                                ##
##             Source_File: proc_chk_LADB.ksh                                                     ##
##                   $Date: 2018-02-05 13:28:26 -0500 (Mon, 05 Feb 2018) $:
##                 $Author: ad.jeff.gilbertson $:
##                    $Rev: 1030 $:
##                                                                                                ##
## DO NOT MODIFY THIS FILE DIRECTLY OR YOU WILL RUN THE RISK OF HAVING ALL OF YOUR CHANGES        ##
## SUMMARILY OVERWRITTEN.                                                                         ##
##                                                                                                ##
## For questions, please contact us at AM_Unix@com2.com.                                        ##
##                                                                                                ##
####################################################################################################
##                                                                                                ##
## proc_chk_LADB.ksh                                                                              ##
##     Check LADB authorizations for named account or group.                                      ##
##                                                                                                ##
####################################################################################################
